...
public class Task3 {
    public static void main(String[] args) {
        ...
        double num2 = 3.2;
        double num3 = 8.1;
        // Знаходимо менше по модулю число
        double minModulus = findMinModulus(num1, num2, num3);
        System.out.println("Менше по модулю число: " + minModulus);
        // Знаходимо саме менше число (не модуль)
        double minValue = findMinValue(num1, num2, num3);
        System.out.println("Саме менше число: " + minValue);
    }
